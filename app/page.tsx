...
const topStories = [
  { rank: "01", category: "市场信号", title: "J.B. Hunt二季度量价齐升并超出市场预期", summary: "多式联运装载量增长10%，经纪业务结束连续13个季度亏损，市场回暖得到头部企业经营数据印证。", signal: "销售机会", signalText: "用头部企业数据解释旺季价格变化", tone: "blue" },
  { rank: "02", category: "合规监管", title: "OOIDA推动《达莉拉法案》收紧CDL资格审查", summary: "法案拟将非本地CDL限制和驾驶员筛查要求写入法律，合规司机供给可能进一步收紧。", signal: "风险提醒", signalText: "提前复核司机身份与CDL有效性", tone: "orange" },
  { rank: "03", category: "车队技术", title: "特斯拉Semi与自动驾驶卡车商业测试同步推进", summary: "芝加哥专用运输线路启动电动重卡评估，Waabi同时验证跨车型自动驾驶软件迁移能力。", signal: "趋势观察", signalText: "关注固定线路的新运力成本结构", tone: "violet" },
];
    ...
    <main className="app-shell">
      ...
      <section className="content-area">
        <header className="topbar">
          ...
          <div className="topbar-actions"><button className="icon-button" aria-label="邮件通知">✉</button><div className="update-pill"><i />已更新 <strong>09:08</strong></div></div>
        </header>

        <div className="workspace">
          <div className="main-column">
            <section className="morning-brief" id="today">
              <div className="brief-copy"><div className="brief-kicker">KAKA MORNING BRIEF · 第 002 期</div><h2>头部企业确认市场转暖，<br />司机合规门槛继续提高。</h2><p>J.B. Hunt二季度量价齐升并恢复经纪业务盈利；OOIDA推动国会永久收紧非本地CDL规则。销售可用经营数据解释旺季调价，同时提前核验司机身份、资质与承运商合规记录。</p><div className="brief-actions"><a href="#news" className="primary-button">阅读完整晨报 <span>→</span></a><span>预计阅读 8 分钟</span></div></div>
